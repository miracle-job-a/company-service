...
@Operation(summary = "최신/마감임박 공고 조회", description = "최신 공고 3건, 마감임박 공고 3건을 반환합니다.",
        responses = {
                @ApiResponse(responseCode = "200",
                        ...
                        content = @Content(
                                ...
                                examples = {
                                        @ExampleObject(
                                                name = "성공",
                                                value = "{\"httpStatus\": 200, \"message\": \"최신 공고, 마감임박 공고 조회 성공\", \"data\": Map<String,Object> newest, deadline}")
